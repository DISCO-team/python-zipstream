...
class ZipFile(zipfile.ZipFile):
    ...
    def write_iter(self, arcname, iterable, compress_type=None, attributes=None, buffer_size=None):
    ...
    def __write(self, filename=None, iterable=None, arcname=None, compress_type=None, attributes=None, buffer_size=None):
